    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            <div className="flex flex-col md:flex-row bg-white rounded-lg shadow-lg overflow-hidden max-w-4xl w-full">
                ...
                <div className="w-full md:w-1/2 p-8">
                    <h2 className="text-2xl font-semibold text-orange-600 mb-6">Sign in to your account</h2>
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center">
                            ...
                            <label htmlFor="terms" className="text-sm text-gray-600">
                                I accept the{' '}
                                <a href="/terms" className="text-orange-600">terms of use</a> and{' '}
                                <a href="/privacy" className="text-orange-600">privacy policy</a>
                            </label>
                        </div>
                        <button
                            type="submit"
