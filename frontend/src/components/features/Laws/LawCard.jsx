...
//     const handleClick = () => {
//         // Navigate to a detailed view using the law's ID
...
//     return (
//         <div
//             className="py-20 border-2 border-orange-500 rounded-lg p-4 m-2 shadow-lg hover:shadow-xl transition-shadow cursor-pointer"
