...
//     <div className={`flex flex-col items-center justify-center p-8 rounded-lg shadow-lg ${highlight ? 'bg-orange-500 text-white' : 'bg-white'}`}>
//         <div className={` text-2xl font-bold ${highlight ? 'text-white' : 'text-gray-800'}`}>{number}</div>
//         <div className={`text-sm mt-1 text-center ${highlight ? 'text-white' : 'text-gray-600'}`}>{label}</div>
//     </div>
// );
